...
<section>
    <?php
        if (isset($_SESSION["useruid"])) {
            echo '<p>Hello, '.$_SESSION["useruid"] .'. Welcome to the R-BIM Platform! Please, check the manual before starting to use the platform. We wish you a nice experience here</p>';
